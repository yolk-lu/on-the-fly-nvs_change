...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, dc, shs, scales, rotations, viewmatrix, sh_degree=None):
        
        raster_settings = self.raster_settings
        
        if sh_degree is not None:
            raster_settings = raster_settings._replace(sh_degree=sh_degree)
