...
python scripts/render_smooth_lod.py \
   -m ./results/Mip-NeRF360/garden/sg_optimization/downsample_3.5/lod_3 \
   --lod_fine 3 \
   --lod_coarse 1 \
   --render_path ./results/Mip-NeRF360/garden/sg_optimization/downsample_3.5/colmap \
   --out_dir ./results/Mip-NeRF360/garden/sg_optimization/downsample_3.5/render_sg_optimize \
   --tau_min 0.8 --tau_max 2.0 \
   --k_ecc 0.3 \