...
python train_lod.py -s /home/cglab/project/Dataset_opensource/Mip-NeRF360/garden -m results/Mip-NeRF360/garden/changing_LoD_v1/downsample_3.5/diff_gaussian_rasterizer_SH_MIX_SG/ --downsampling 3.5 --test_hold 20 --lod_min 1 --lod_max 3 --increase_lod_num_childs 2